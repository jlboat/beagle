...
public class RunStats {
   ...
   /**
    ...
    public void printSampleSummary(Data data) {
        ...
        GT refGT = data.refGT();
        int nRefSamples = refGT==null ? 0 : refGT.nSamples();
   ...
   /**
    ...
    public void printWindowUpdate(Data data) {
        Markers markers = data.refGT()!=null ? data.refGT().markers() :
                data.targGT().markers();
        ...
        sb.append(String.format("Study markers:     %,11d%n",
                data.targGT().nMarkers()));
    ...
    public void printPhasingItUpdate(int it, boolean burnin, long elapsedNanos) {
