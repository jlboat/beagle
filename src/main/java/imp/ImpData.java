...
public class ImpData {
     ...
     * @param data the input data for the current marker window
     ...
     */
    public ImpData(Par par, Data data, GT phasedTarg, GeneticMap map) {
        if (data.targGT().markers().equals(phasedTarg.markers())==false) {
            throw new IllegalArgumentException("inconsistent markers");
        }
        if (data.targGT().samples().equals(phasedTarg.samples())==false) {
